...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'title' | 'textSnippet' | 'upvotes' | 'downvotes' | 'createdAt' | 'updatedAt' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'text' | 'upvotes' | 'downvotes' | 'creatorId' | 'createdAt' | 'updatedAt'>
  ) }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'text' | 'upvotes' | 'downvotes' | 'createdAt' | 'updatedAt' | 'voteStatus'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'username'>
    ) }
